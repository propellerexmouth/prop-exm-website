...
<div class="contact">
    <div class="contact__container">
        <p>
            <a class="button--messenger" href="https://m.me/propellerexmouth"><i class="fa fa-temp-messenger"></i> Chat on Messenger</a>
        </p>
...
<!-- Modal -->
<div id="subscriptionForm" class="modal fade" role="dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="message__container">
                    <p class="message__info"></p>
                    <ul></ul>
                </div>
                <form id="subscription-form" class="form" action="/subscribe" method="post">
                    {{ csrf_field() }}
                    <div class="form-group">
                        <label for="frmFirstName">First Name</label>
                        <input class="form-control" type="text" placeholder="First Name" id="frmFirstName" name="first_name" value="{{ old('first_name') }}">
                        @if ($errors->has('first_name'))
                            <div class="form__error_container">{{ $errors->first('first_name') }}</div>
                        @endif
                    </div>
                    <div class="form-group">
                        <label for="frmLastName">Last Name</label>
                        <input class="form-control" type="text" placeholder="Last Name" id="frmLastName" name="last_name" value="{{ old('last_name') }}">
                        @if ($errors->has('last_name'))
                            <div class="form__error_container">{{ $errors->first('last_name') }}</div>
                        @endif
                    </div>
                    <div class="form-group">
                        <label for="frmEmail">Email</label>
                        <input class="form-control" type="email" placeholder="you@somewhere.com" id="frmEmail" name="email" value="{{ old('email') }}">
                        @if ($errors->has('email'))
                            <div class="form__error_container">{{ $errors->first('email') }}</div>
                        @endif
                    </div>
                    <div class="form-group">
